...
const screens = [
  ...
  { src: '/screenshots/bookmarks.png', label: 'Bookmarks', alt: 'Pulse Pro bookmarks for saving important items', description: 'Save articles, videos, and links to any project. Your research, organized.' },
];
