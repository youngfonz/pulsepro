...
const features = [
  ...
  },
  {
    ...
    description: 'One dashboard. Every deadline, client, and status.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Daily reminders, calendar view, and priority sorting.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Details, history, and active work in one place.',
  },
];
